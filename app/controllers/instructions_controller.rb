class InstructionsController < ApplicationController
  ...
  def show
    ...
    @recipe_path = "/recipes/#{@instruction.recipe_id}"
  ...
  def new
    @instruction = Instruction.new(:recipe_id => params[:recipe_id])
    @recipe_path = "/recipes/#{@instruction.recipe_id}"
  ...
  def create
    ...
    respond_to do |format|
      if @instruction.save
        format.html { redirect_to(Recipe.find(@instruction.recipe_id), :notice => 'Instruction was successfully created.') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(Recipe.find(@instruction.recipe_id)) }
      format.xml  { head :ok }
    end
  end
end
